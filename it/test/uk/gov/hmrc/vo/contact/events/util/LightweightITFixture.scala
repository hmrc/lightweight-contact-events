...
package uk.gov.hmrc.vo.contact.events.util

import uk.gov.hmrc.vo.contact.events.models.ConfirmedContactDetails.toLegacyContact
import uk.gov.hmrc.vo.contact.events.models.{ConfirmedContactDetails, Contact, PropertyAddress, QueuedDataTransfer, VODataTransfer}

object LightweightITFixture:

  val message                                          = "MSG"
  val subject                                          = "Valuation Office Contact Form"
  ...
  val ctDataTransfer: VODataTransfer =
    VODataTransfer(toLegacyContact(confirmedContactDetails), propertyAddress, true, subject, ctEmail, enquiryCategoryMsg, subEnquiryCategoryMsg, message)

  val brDataTransfer: VODataTransfer =
    VODataTransfer(toLegacyContact(confirmedContactDetails), propertyAddress, false, subject, brEmail, enquiryCategoryMsg, subEnquiryCategoryMsg, message)
  ...
  val housingBenefitEmail           = "NSOhelpdeskvo@hmrc.gov.uk"
  ...
  val housingBenefitDataTransfer: VODataTransfer = VODataTransfer(
  ...
  def aQueuedDataTransfer(): QueuedDataTransfer =
    QueuedDataTransfer(aVODataTransfer())

  def aVODataTransfer(): VODataTransfer =
    VODataTransfer(
  ...
  def brVODataTransfer(): VODataTransfer =
    VODataTransfer(
      toLegacyContact(aConfirmedContactDetails()),
      aPropertyAddress(),
      false,
